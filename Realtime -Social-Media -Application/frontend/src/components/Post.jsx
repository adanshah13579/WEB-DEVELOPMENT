...
const Post = ({ post }) => {
  ...
  return (
    <div className=" max-w-4xl ml-40 py-8 pl-[20%]" >
      

      {/* Post Section */}
      <div className="bg-white border rounded-lg shadow-lg p-6 my-8 w-full">
        ...
        <img
          className="rounded-lg my-2 w-full max-h-[600px] object-cover"
          src={post.image}
          alt="post_img"
        />
